...
class ControlLoop:
    ...
    def _update_robot(self):
        ...
        # Update left arm (simulation mode or connected)
        ...
        # Update right arm (simulation mode or connected)
        ...
        # Send commands to real robot only if engaged
    ...
    def _update_visualization(self):
        ...
        # Update robot poses for both arms using current angles (from IK or hardware)
        left_angles = self.robot_interface.get_arm_angles("left")
        right_angles = self.robot_interface.get_arm_angles("right")
