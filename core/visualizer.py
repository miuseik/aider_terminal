...
class PyBulletVisualizer:
    ...
    def setup(self) -> bool:
        ...
        # 1. 构建 URDF 文件路径
        #    __file__ = visualizer.py 的绝对路径 (在 core/ 目录下)
        #    os.path.dirname(__file__) = core/ 目录
        #    os.path.dirname(os.path.dirname(__file__)) = 项目根目录
        #    最终路径: /home/gaoda/www/codeing/aider/aider_terminal/URDF/aloha/Aloha.urdf
        aloha_urdf_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 
