...
logger = logging.getLogger("robstride.slcan_driver")
...
class SlcanCanDriver:
    ...
    def __init__(self, serial_port: str, host_can_id: int = 0xFD,
        ...
        if serial is None:
            raise ImportError("pyserial is required for SlcanCanDriver. Install: pip install pyserial")
