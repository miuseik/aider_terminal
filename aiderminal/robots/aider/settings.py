...
JOINT_LIMIT_OVERRIDES = {
    # -- 左臂 --
    "left_arm1":  (-136, 136),     # shoulder pan (X轴), 原始值未修改
    "left_arm2":  (-60, 91),       # shoulder lift (Y轴), 下限收紧防肘顶身体
    "left_arm3":  (-10, 90),       # elbow flex (Z轴), 原始 -91~91, 缩到 -10~90
    "left_arm4":  (-1, 136),       # wrist (X轴), 原始值未修改
    "left_arm5":  (-91, 91),       # 原始值，未修改
    "left_arm6":  (-30, 30),       # 原始值，未修改
    "left_arm7":  (-30, 30),       # 原始值，未修改
    "left_arm8":  (-91, 1),        # 原始值，未修改
    # -- 右臂 --
    "right_arm1": (-136, 136),     # shoulder pan (X轴), 原始值未修改
    "right_arm2": (-60, 91),       # shoulder lift (Y轴), 下限收紧防肘顶身体
    "right_arm3": (-10, 90),       # elbow flex (Z轴), 原始 -91~91, 缩到 -10~90
