...
class ActuatorController:
    ...
    def _get_or_create_driver(self, port: str):
        ...
        if "can" in port.lower():
            ...
            from src.drivers.actuator.robStride import RobStrideOfficialDriver
            from src.drivers.actuator.robStride.robstride_dynamics.protocol import MotorType
            ...
            from src.drivers.actuator.feetech.feetech_driver import ST3215Driver
            driver = ST3215Driver(
                port,
