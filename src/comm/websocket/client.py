    ...
    async def _handle_command(self, command):
        ...
        if action == 'enable_keyboard':
            ...
            if cl and cl.robot_interface:
                ...
                from src.utils.hardware_info import push_robot_hardware_info
            ...
            if cl and cl.robot_interface:
                ...
                from src.controller.pose_controller import goto_pose
            ...
            from src.config.settings import get_default_pose_name
