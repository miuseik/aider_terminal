...
class MotorType(IntEnum):
    """电机型号（与 C++ ActuatorType 0~6 一一对应）"""
    RS00 = 0   # 力矩 ±17Nm, 速度 ±50rad/s,  kp_max=500,  kd_max=5
    RS01 = 1   # 力矩 ±17Nm, 速度 ±44rad/s,  kp_max=500,  kd_max=5
    RS02 = 2   # 力矩 ±17Nm, 速度 ±44rad/s,  kp_max=500,  kd_max=5
    RS03 = 3   # 力矩 ±60Nm, 速度 ±50rad/s,  kp_max=5000, kd_max=100  ← 高增益
    RS04 = 4   # 力矩 ±120Nm,速度 ±15rad/s,  kp_max=5000, kd_max=100  ← 高增益
    RS05 = 5   # 力矩 ±17Nm, 速度 ±33rad/s,  kp_max=500,  kd_max=5
    RS06 = 6   # 力矩 ±36Nm, 速度 ±20rad/s,  kp_max=5000, kd_max=100  ← 高增益
    # 旧名称保留向后兼容
    EL05 = 1   # alias for RS01
...
MOTOR_PARAMS = {
    MotorType.RS00: MotorParams(
        v_min=-50.0, v_max=50.0, t_min=-17.0, t_max=17.0,
        kp_min=0.0, kp_max=500.0, kd_min=0.0, kd_max=5.0,
    ),
    MotorType.RS01: MotorParams(
        v_min=-44.0, v_max=44.0, t_min=-17.0, t_max=17.0,
        kp_min=0.0, kp_max=500.0, kd_min=0.0, kd_max=5.0,
    ),
    MotorType.RS02: MotorParams(
        v_min=-44.0, v_max=44.0, t_min=-17.0, t_max=17.0,
        kp_min=0.0, kp_max=500.0, kd_min=0.0, kd_max=5.0,
    ),
    MotorType.RS03: MotorParams(
        v_min=-50.0, v_max=50.0, t_min=-60.0, t_max=60.0,
        kp_min=0.0, kp_max=5000.0, kd_min=0.0, kd_max=100.0,
    ),
    MotorType.RS04: MotorParams(
        v_min=-15.0, v_max=15.0, t_min=-120.0, t_max=120.0,
        kp_min=0.0, kp_max=5000.0, kd_min=0.0, kd_max=100.0,
    ),
    MotorType.RS05: MotorParams(
        v_min=-33.0, v_max=33.0, t_min=-17.0, t_max=17.0,
        kp_min=0.0, kp_max=500.0, kd_min=0.0, kd_max=5.0,
    ),
    MotorType.RS06: MotorParams(
        v_min=-20.0, v_max=20.0, t_min=-60.0, t_max=60.0,
        kp_min=0.0, kp_max=5000.0, kd_min=0.0, kd_max=100.0,
    ),
}
